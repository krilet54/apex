  ...
  return (
    <PageContainer>
      <div style={vars} className="max-w-6xl mx-auto px-4">
        ...
        {/* Hero: merged image + heading with heavy diagonal olive overlay */}
        <motion.header initial="hidden" animate="show" variants={container} className="relative overflow-hidden text-white rounded-md">
          {/* background image */}
          ...
          <div className="relative" style={{ minHeight: '44vh' }}>
          ...
          <article className="lg:col-span-2">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                {service.details && service.details.map((d, idx) => (
