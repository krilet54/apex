...
export default function Services() {
  ...
  return (
    <>
      <section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-gradient-to-br from-[#0B1F13] via-[#1B3B24] to-[#1F4A2C] text-white py-12 lg:py-16 border-y border-white/10">
      ...
      <PageContainer>
        <section className="mt-0">
          <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white border-y border-[#E8E0CF] py-14">
            <div className="container mx-auto px-6 lg:px-12">
        ...
        <section className="mt-16 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <div>
            ...
            <div className="mt-6 space-y-6">
              {faqs.map((faq) => (
                <details key={faq.question} className="rounded-2xl border border-[#E5DCCB] bg-white/80 p-5">
          ...
          <div className="rounded-[32px] bg-gradient-to-br from-[#FDF5E7] to-white border border-[#EEDFC6] p-8 text-center">
