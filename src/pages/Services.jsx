    ...
    <>
      ...
      <PageContainer>
        <section className="mt-0">
          ...
          >
            <div className="container mx-auto px-6 lg:px-12">
              <p className="text-xs uppercase tracking-[0.35em] text-[#58761B]">Service Portfolio</p>
        ...
        >
          ...
          >
            <p className="text-xs uppercase tracking-[0.35em] text-[#9F6B1F]">Need a tailored solution?</p>
